...
.config(function ($stateProvider, $urlRouterProvider, $locationProvider, $breadcrumbProvider, $mdAriaProvider) {
		"ngInject";
		...
		var states = [
			...
			},
			{
				...
				resolve: {
					...
					collectionsLabel: function($stateParams, $rootScope){
						"ngInject";
			...
			},
			{
				...
				resolve: {
					...
					collectionLabel: function($stateParams, $rootScope, $collectionService){
						"ngInject";
			...
			},*/
			{
				...
				resolve: {
					...
					itemLabel: function($rootScope, $stateParams){
						"ngInject"
